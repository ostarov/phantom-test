...
QT_MOC_LITERAL(3, 26, 8)
    ...
    "Terminal\0encodingChanged\0\0encoding"
};
...
void Terminal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->encodingChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Terminal::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Terminal::encodingChanged)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Terminal::encodingChanged(const QString & _t1)
{
