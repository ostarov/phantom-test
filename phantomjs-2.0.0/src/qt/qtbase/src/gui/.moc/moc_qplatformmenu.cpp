...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QPlatformMenuItem_t, stringdata) + ofs \
...
const QMetaObject QPlatformMenuItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QPlatformMenuItem.data,
      qt_meta_data_QPlatformMenuItem,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QPlatformMenuItem.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QPlatformMenu_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QPlatformMenu::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QPlatformMenu.data,
      qt_meta_data_QPlatformMenu,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QPlatformMenu.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QPlatformMenuBar_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QPlatformMenuBar::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QPlatformMenuBar.data,
      qt_meta_data_QPlatformMenuBar,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QPlatformMenuBar.stringdata))
