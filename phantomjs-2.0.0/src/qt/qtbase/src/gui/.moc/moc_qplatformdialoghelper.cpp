...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QPlatformDialogHelper_t, stringdata) + ofs \
...
const QMetaObject QPlatformDialogHelper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QPlatformDialogHelper.data,
      qt_meta_data_QPlatformDialogHelper,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QPlatformDialogHelper.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QPlatformColorDialogHelper_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QPlatformColorDialogHelper::staticMetaObject = {
    { &QPlatformDialogHelper::staticMetaObject, qt_meta_stringdata_QPlatformColorDialogHelper.data,
      qt_meta_data_QPlatformColorDialogHelper,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QPlatformColorDialogHelper.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QPlatformFontDialogHelper_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QPlatformFontDialogHelper::staticMetaObject = {
    { &QPlatformDialogHelper::staticMetaObject, qt_meta_stringdata_QPlatformFontDialogHelper.data,
      qt_meta_data_QPlatformFontDialogHelper,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QPlatformFontDialogHelper.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QPlatformFileDialogHelper_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QPlatformFileDialogHelper::staticMetaObject = {
    { &QPlatformDialogHelper::staticMetaObject, qt_meta_stringdata_QPlatformFileDialogHelper.data,
      qt_meta_data_QPlatformFileDialogHelper,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QPlatformFileDialogHelper.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QPlatformMessageDialogHelper_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
QT_MOC_LITERAL(4, 76, 6),
QT_MOC_LITERAL(5, 83, 33),
QT_MOC_LITERAL(6, 117, 4)
    },
...
const QMetaObject QPlatformMessageDialogHelper::staticMetaObject = {
    { &QPlatformDialogHelper::staticMetaObject, qt_meta_stringdata_QPlatformMessageDialogHelper.data,
      qt_meta_data_QPlatformMessageDialogHelper,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QPlatformMessageDialogHelper.stringdata))
