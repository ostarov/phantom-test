...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QPlatformSystemTrayIcon_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 35, 41),
QT_MOC_LITERAL(4, 77, 6),
QT_MOC_LITERAL(5, 84, 14)
    },
    "QPlatformSystemTrayIcon\0activated\0\0"
    "QPlatformSystemTrayIcon::ActivationReason\0"
    "reason\0messageClicked"
};
...
const QMetaObject QPlatformSystemTrayIcon::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QPlatformSystemTrayIcon.data,
      qt_meta_data_QPlatformSystemTrayIcon,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QPlatformSystemTrayIcon.stringdata))
