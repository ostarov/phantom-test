...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QTextObject_t, stringdata) + ofs \
...
const QMetaObject QTextObject::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QTextObject.data,
      qt_meta_data_QTextObject,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QTextObject.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QTextBlockGroup_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QTextBlockGroup::staticMetaObject = {
    { &QTextObject::staticMetaObject, qt_meta_stringdata_QTextBlockGroup.data,
      qt_meta_data_QTextBlockGroup,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QTextBlockGroup.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QTextFrame_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QTextFrame::staticMetaObject = {
    { &QTextObject::staticMetaObject, qt_meta_stringdata_QTextFrame.data,
      qt_meta_data_QTextFrame,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QTextFrame.stringdata))
