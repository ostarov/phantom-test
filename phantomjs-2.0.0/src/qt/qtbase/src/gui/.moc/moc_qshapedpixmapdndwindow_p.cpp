...
#include "../kernel/qshapedpixmapdndwindow_p.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QShapedPixmapWindow_t, stringdata) + ofs \
...
const QMetaObject QShapedPixmapWindow::staticMetaObject = {
    { &QWindow::staticMetaObject, qt_meta_stringdata_QShapedPixmapWindow.data,
      qt_meta_data_QShapedPixmapWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QShapedPixmapWindow.stringdata))
