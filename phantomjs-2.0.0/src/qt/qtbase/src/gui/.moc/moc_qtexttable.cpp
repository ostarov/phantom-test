...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QTextTable_t, stringdata) + ofs \
...
const QMetaObject QTextTable::staticMetaObject = {
    { &QTextFrame::staticMetaObject, qt_meta_stringdata_QTextTable.data,
      qt_meta_data_QTextTable,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QTextTable.stringdata))
