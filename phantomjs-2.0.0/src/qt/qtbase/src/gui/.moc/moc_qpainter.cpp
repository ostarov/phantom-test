...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QPainter_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 96, 21),
QT_MOC_LITERAL(7, 118, 21),
...
const QMetaObject QPainter::staticMetaObject = {
    { 0, qt_meta_stringdata_QPainter.data,
      qt_meta_data_QPainter,  0, 0, 0}
};
