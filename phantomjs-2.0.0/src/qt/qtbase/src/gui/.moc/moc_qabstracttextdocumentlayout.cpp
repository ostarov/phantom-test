...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QAbstractTextDocumentLayout_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 85, 7),
QT_MOC_LITERAL(8, 93, 16),
QT_MOC_LITERAL(9, 110, 8),
QT_MOC_LITERAL(10, 119, 19),
QT_MOC_LITERAL(11, 139, 3),
QT_MOC_LITERAL(12, 143, 23),
QT_MOC_LITERAL(13, 167, 26)
    },
...
const QMetaObject QAbstractTextDocumentLayout::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QAbstractTextDocumentLayout.data,
      qt_meta_data_QAbstractTextDocumentLayout,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QAbstractTextDocumentLayout.stringdata))
