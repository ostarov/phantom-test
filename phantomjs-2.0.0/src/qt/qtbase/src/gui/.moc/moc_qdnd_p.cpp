...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QInternalMimeData_t, stringdata) + ofs \
...
const QMetaObject QInternalMimeData::staticMetaObject = {
    { &QMimeData::staticMetaObject, qt_meta_stringdata_QInternalMimeData.data,
      qt_meta_data_QInternalMimeData,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QInternalMimeData.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QDragManager_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QDragManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QDragManager.data,
      qt_meta_data_QDragManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QDragManager.stringdata))
