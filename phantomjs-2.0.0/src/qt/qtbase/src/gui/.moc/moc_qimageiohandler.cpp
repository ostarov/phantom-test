...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QImageIOPlugin_t, stringdata) + ofs \
...
const QMetaObject QImageIOPlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QImageIOPlugin.data,
      qt_meta_data_QImageIOPlugin,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QImageIOPlugin.stringdata))
