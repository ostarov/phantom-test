...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QSqlQueryModel_t, stringdata) + ofs \
...
const QMetaObject QSqlQueryModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_QSqlQueryModel.data,
      qt_meta_data_QSqlQueryModel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QSqlQueryModel.stringdata))
