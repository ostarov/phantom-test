...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QSqlRelationalTableModel_t, stringdata) + ofs \
...
const QMetaObject QSqlRelationalTableModel::staticMetaObject = {
    { &QSqlTableModel::staticMetaObject, qt_meta_stringdata_QSqlRelationalTableModel.data,
      qt_meta_data_QSqlRelationalTableModel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QSqlRelationalTableModel.stringdata))
