...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QSQLiteDriver_t, stringdata) + ofs \
...
const QMetaObject QSQLiteDriver::staticMetaObject = {
    { &QSqlDriver::staticMetaObject, qt_meta_stringdata_QSQLiteDriver.data,
      qt_meta_data_QSQLiteDriver,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QSQLiteDriver.stringdata))
