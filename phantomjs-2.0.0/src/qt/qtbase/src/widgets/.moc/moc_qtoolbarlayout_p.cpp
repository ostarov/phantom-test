...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QToolBarLayout_t, stringdata) + ofs \
...
const QMetaObject QToolBarLayout::staticMetaObject = {
    { &QLayout::staticMetaObject, qt_meta_stringdata_QToolBarLayout.data,
      qt_meta_data_QToolBarLayout,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QToolBarLayout.stringdata))
