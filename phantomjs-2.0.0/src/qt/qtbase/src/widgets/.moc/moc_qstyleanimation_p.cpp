...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QStyleAnimation_t, stringdata) + ofs \
...
const QMetaObject QStyleAnimation::staticMetaObject = {
    { &QAbstractAnimation::staticMetaObject, qt_meta_stringdata_QStyleAnimation.data,
      qt_meta_data_QStyleAnimation,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QStyleAnimation.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QProgressStyleAnimation_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QProgressStyleAnimation::staticMetaObject = {
    { &QStyleAnimation::staticMetaObject, qt_meta_stringdata_QProgressStyleAnimation.data,
      qt_meta_data_QProgressStyleAnimation,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QProgressStyleAnimation.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QNumberStyleAnimation_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QNumberStyleAnimation::staticMetaObject = {
    { &QStyleAnimation::staticMetaObject, qt_meta_stringdata_QNumberStyleAnimation.data,
      qt_meta_data_QNumberStyleAnimation,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QNumberStyleAnimation.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QBlendStyleAnimation_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QBlendStyleAnimation::staticMetaObject = {
    { &QStyleAnimation::staticMetaObject, qt_meta_stringdata_QBlendStyleAnimation.data,
      qt_meta_data_QBlendStyleAnimation,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QBlendStyleAnimation.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QScrollbarStyleAnimation_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QScrollbarStyleAnimation::staticMetaObject = {
    { &QNumberStyleAnimation::staticMetaObject, qt_meta_stringdata_QScrollbarStyleAnimation.data,
      qt_meta_data_QScrollbarStyleAnimation,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QScrollbarStyleAnimation.stringdata))
