...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QMainWindowLayout_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 29, 0)
    ...
    "QMainWindowLayout\0tabChanged\0"
};
...
const QMetaObject QMainWindowLayout::staticMetaObject = {
    { &QLayout::staticMetaObject, qt_meta_stringdata_QMainWindowLayout.data,
      qt_meta_data_QMainWindowLayout,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QMainWindowLayout.stringdata))
