...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QScrollBar_t, stringdata) + ofs \
...
const QMetaObject QScrollBar::staticMetaObject = {
    { &QAbstractSlider::staticMetaObject, qt_meta_stringdata_QScrollBar.data,
      qt_meta_data_QScrollBar,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QScrollBar.stringdata))
