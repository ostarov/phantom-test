...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QCommonStyle_t, stringdata) + ofs \
...
const QMetaObject QCommonStyle::staticMetaObject = {
    { &QStyle::staticMetaObject, qt_meta_stringdata_QCommonStyle.data,
      qt_meta_data_QCommonStyle,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QCommonStyle.stringdata))
