...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QInputDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(9, 112, 19),
QT_MOC_LITERAL(10, 132, 14),
QT_MOC_LITERAL(11, 147, 27),
QT_MOC_LITERAL(12, 175, 20)
    },
...
const QMetaObject QInputDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_QInputDialog.data,
      qt_meta_data_QInputDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QInputDialog.stringdata))
