...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QMouseEventTransition_t, stringdata) + ofs \
...
const QMetaObject QMouseEventTransition::staticMetaObject = {
    { &QEventTransition::staticMetaObject, qt_meta_stringdata_QMouseEventTransition.data,
      qt_meta_data_QMouseEventTransition,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QMouseEventTransition.stringdata))
