...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QSplitter_t, stringdata) + ofs \
...
const QMetaObject QSplitter::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_QSplitter.data,
      qt_meta_data_QSplitter,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QSplitter.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QSplitterHandle_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QSplitterHandle::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QSplitterHandle.data,
      qt_meta_data_QSplitterHandle,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QSplitterHandle.stringdata))
