...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QUndoAction_t, stringdata) + ofs \
...
const QMetaObject QUndoAction::staticMetaObject = {
    { &QAction::staticMetaObject, qt_meta_stringdata_QUndoAction.data,
      qt_meta_data_QUndoAction,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QUndoAction.stringdata))
