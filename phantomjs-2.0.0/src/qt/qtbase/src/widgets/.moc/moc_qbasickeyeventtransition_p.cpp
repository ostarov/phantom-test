...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QBasicKeyEventTransition_t, stringdata) + ofs \
...
const QMetaObject QBasicKeyEventTransition::staticMetaObject = {
    { &QAbstractTransition::staticMetaObject, qt_meta_stringdata_QBasicKeyEventTransition.data,
      qt_meta_data_QBasicKeyEventTransition,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QBasicKeyEventTransition.stringdata))
