...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QAbstractScrollArea_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 65, 23),
QT_MOC_LITERAL(6, 89, 19),
QT_MOC_LITERAL(7, 109, 25),
QT_MOC_LITERAL(8, 135, 16),
QT_MOC_LITERAL(9, 152, 16),
QT_MOC_LITERAL(10, 169, 13),
...
const QMetaObject QAbstractScrollArea::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_QAbstractScrollArea.data,
      qt_meta_data_QAbstractScrollArea,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QAbstractScrollArea.stringdata))
...
int QAbstractScrollArea::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: *reinterpret_cast< SizeAdjustPolicy*>(_v) = sizeAdjustPolicy(); break;
        }
        _id -= 3;
        ...
        case 2: setSizeAdjustPolicy(*reinterpret_cast< SizeAdjustPolicy*>(_v)); break;
        }
        _id -= 3;
