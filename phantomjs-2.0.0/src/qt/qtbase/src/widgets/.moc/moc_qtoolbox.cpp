...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QToolBox_t, stringdata) + ofs \
...
const QMetaObject QToolBox::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_QToolBox.data,
      qt_meta_data_QToolBox,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QToolBox.stringdata))
