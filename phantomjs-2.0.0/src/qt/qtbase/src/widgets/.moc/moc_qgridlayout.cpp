...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QGridLayout_t, stringdata) + ofs \
...
const QMetaObject QGridLayout::staticMetaObject = {
    { &QLayout::staticMetaObject, qt_meta_stringdata_QGridLayout.data,
      qt_meta_data_QGridLayout,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QGridLayout.stringdata))
