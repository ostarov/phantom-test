...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QWidgetAction_t, stringdata) + ofs \
...
const QMetaObject QWidgetAction::staticMetaObject = {
    { &QAction::staticMetaObject, qt_meta_stringdata_QWidgetAction.data,
      qt_meta_data_QWidgetAction,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QWidgetAction.stringdata))
