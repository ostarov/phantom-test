...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QColumnView_t, stringdata) + ofs \
...
const QMetaObject QColumnView::staticMetaObject = {
    { &QAbstractItemView::staticMetaObject, qt_meta_stringdata_QColumnView.data,
      qt_meta_data_QColumnView,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QColumnView.stringdata))
