...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QDockWidgetLayout_t, stringdata) + ofs \
...
const QMetaObject QDockWidgetLayout::staticMetaObject = {
    { &QLayout::staticMetaObject, qt_meta_stringdata_QDockWidgetLayout.data,
      qt_meta_data_QDockWidgetLayout,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QDockWidgetLayout.stringdata))
