...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QProxyStyle_t, stringdata) + ofs \
...
const QMetaObject QProxyStyle::staticMetaObject = {
    { &QCommonStyle::staticMetaObject, qt_meta_stringdata_QProxyStyle.data,
      qt_meta_data_QProxyStyle,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QProxyStyle.stringdata))
