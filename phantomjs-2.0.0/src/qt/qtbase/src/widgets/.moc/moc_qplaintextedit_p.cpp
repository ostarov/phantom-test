...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QPlainTextEditControl_t, stringdata) + ofs \
...
const QMetaObject QPlainTextEditControl::staticMetaObject = {
    { &QWidgetTextControl::staticMetaObject, qt_meta_stringdata_QPlainTextEditControl.data,
      qt_meta_data_QPlainTextEditControl,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QPlainTextEditControl.stringdata))
