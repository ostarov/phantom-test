...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QActionGroup_t, stringdata) + ofs \
...
QT_MOC_LITERAL(13, 143, 9),
QT_MOC_LITERAL(14, 153, 7),
QT_MOC_LITERAL(15, 161, 7)
    },
...
const QMetaObject QActionGroup::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QActionGroup.data,
      qt_meta_data_QActionGroup,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QActionGroup.stringdata))
