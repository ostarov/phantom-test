...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QMdiSubWindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(9, 111, 23),
QT_MOC_LITERAL(10, 135, 23),
QT_MOC_LITERAL(11, 159, 22),
QT_MOC_LITERAL(12, 182, 8),
QT_MOC_LITERAL(13, 191, 18),
...
const QMetaObject QMdiSubWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QMdiSubWindow.data,
      qt_meta_data_QMdiSubWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QMdiSubWindow.stringdata))
