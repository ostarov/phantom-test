...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QBoxLayout_t, stringdata) + ofs \
...
const QMetaObject QBoxLayout::staticMetaObject = {
    { &QLayout::staticMetaObject, qt_meta_stringdata_QBoxLayout.data,
      qt_meta_data_QBoxLayout,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QBoxLayout.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QHBoxLayout_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QHBoxLayout::staticMetaObject = {
    { &QBoxLayout::staticMetaObject, qt_meta_stringdata_QHBoxLayout.data,
      qt_meta_data_QHBoxLayout,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QHBoxLayout.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QVBoxLayout_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QVBoxLayout::staticMetaObject = {
    { &QBoxLayout::staticMetaObject, qt_meta_stringdata_QVBoxLayout.data,
      qt_meta_data_QVBoxLayout,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QVBoxLayout.stringdata))
