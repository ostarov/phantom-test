/****************************************************************************
** Meta object code from reading C++ file 'qwidgetwindow_qpa_p.h'
**
...
#include "../kernel/qwidgetwindow_qpa_p.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'qwidgetwindow_qpa_p.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QWidgetWindow_t, stringdata) + ofs \
...
const QMetaObject QWidgetWindow::staticMetaObject = {
    { &QWindow::staticMetaObject, qt_meta_stringdata_QWidgetWindow.data,
      qt_meta_data_QWidgetWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QWidgetWindow.stringdata))
