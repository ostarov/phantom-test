...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QLineEditIconButton_t, stringdata) + ofs \
...
const QMetaObject QLineEditIconButton::staticMetaObject = {
    { &QToolButton::staticMetaObject, qt_meta_stringdata_QLineEditIconButton.data,
      qt_meta_data_QLineEditIconButton,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QLineEditIconButton.stringdata))
