...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QStyleSheetStyle_t, stringdata) + ofs \
...
const QMetaObject QStyleSheetStyle::staticMetaObject = {
    { &QWindowsStyle::staticMetaObject, qt_meta_stringdata_QStyleSheetStyle.data,
      qt_meta_data_QStyleSheetStyle,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QStyleSheetStyle.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QStyleSheetStyleCaches_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QStyleSheetStyleCaches::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QStyleSheetStyleCaches.data,
      qt_meta_data_QStyleSheetStyleCaches,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QStyleSheetStyleCaches.stringdata))
