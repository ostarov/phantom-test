...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QGroupBox_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 46, 21),
QT_MOC_LITERAL(7, 68, 1),
QT_MOC_LITERAL(8, 70, 5),
...
const QMetaObject QGroupBox::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QGroupBox.data,
      qt_meta_data_QGroupBox,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QGroupBox.stringdata))
