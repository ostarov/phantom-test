...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QScroller_t, stringdata) + ofs \
...
const QMetaObject QScroller::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QScroller.data,
      qt_meta_data_QScroller,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QScroller.stringdata))
...
int QScroller::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: *reinterpret_cast< QScrollerProperties*>(_v) = scrollerProperties(); break;
        }
        _id -= 2;
    } else if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 1: setScrollerProperties(*reinterpret_cast< QScrollerProperties*>(_v)); break;
        }
        _id -= 2;
