...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QCheckBox_t, stringdata) + ofs \
...
const QMetaObject QCheckBox::staticMetaObject = {
    { &QAbstractButton::staticMetaObject, qt_meta_stringdata_QCheckBox.data,
      qt_meta_data_QCheckBox,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QCheckBox.stringdata))
