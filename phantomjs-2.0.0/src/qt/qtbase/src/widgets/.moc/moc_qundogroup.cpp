...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QUndoGroup_t, stringdata) + ofs \
...
QT_MOC_LITERAL(15, 156, 15),
QT_MOC_LITERAL(16, 172, 8),
QT_MOC_LITERAL(17, 181, 4),
QT_MOC_LITERAL(18, 186, 4),
QT_MOC_LITERAL(19, 191, 14)
    },
...
const QMetaObject QUndoGroup::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QUndoGroup.data,
      qt_meta_data_QUndoGroup,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QUndoGroup.stringdata))
