...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QMenuBar_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 55, 7),
QT_MOC_LITERAL(8, 63, 18),
QT_MOC_LITERAL(9, 82, 16),
QT_MOC_LITERAL(10, 99, 28),
...
const QMetaObject QMenuBar::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QMenuBar.data,
      qt_meta_data_QMenuBar,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QMenuBar.stringdata))
