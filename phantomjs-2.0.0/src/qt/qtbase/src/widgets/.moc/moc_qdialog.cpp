...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(8, 53, 4),
QT_MOC_LITERAL(9, 58, 6),
QT_MOC_LITERAL(10, 65, 6),
QT_MOC_LITERAL(11, 72, 13),
...
const QMetaObject QDialog::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QDialog.data,
      qt_meta_data_QDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QDialog.stringdata))
