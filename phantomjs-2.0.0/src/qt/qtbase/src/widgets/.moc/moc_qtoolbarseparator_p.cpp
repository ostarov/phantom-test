...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QToolBarSeparator_t, stringdata) + ofs \
...
const QMetaObject QToolBarSeparator::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QToolBarSeparator.data,
      qt_meta_data_QToolBarSeparator,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QToolBarSeparator.stringdata))
