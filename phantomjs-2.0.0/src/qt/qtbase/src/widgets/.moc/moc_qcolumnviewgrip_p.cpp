...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QColumnViewGrip_t, stringdata) + ofs \
...
const QMetaObject QColumnViewGrip::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QColumnViewGrip.data,
      qt_meta_data_QColumnViewGrip,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QColumnViewGrip.stringdata))
