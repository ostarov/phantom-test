...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QAbstractPrintDialog_t, stringdata) + ofs \
...
const QMetaObject QAbstractPrintDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_QAbstractPrintDialog.data,
      qt_meta_data_QAbstractPrintDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QAbstractPrintDialog.stringdata))
