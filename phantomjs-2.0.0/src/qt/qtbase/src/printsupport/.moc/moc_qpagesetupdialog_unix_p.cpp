...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QPageSetupWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 90, 16),
QT_MOC_LITERAL(7, 107, 8),
QT_MOC_LITERAL(8, 116, 19),
QT_MOC_LITERAL(9, 136, 17),
QT_MOC_LITERAL(10, 154, 18)
    },
...
const QMetaObject QPageSetupWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QPageSetupWidget.data,
      qt_meta_data_QPageSetupWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QPageSetupWidget.stringdata))
