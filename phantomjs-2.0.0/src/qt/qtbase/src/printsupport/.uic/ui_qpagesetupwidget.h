...
#endif // QT_NO_ACCESSIBILITY
        pagesPerSheetButtonGroup->setTitle(QApplication::translate("QPageSetupWidget", "Page Layout", 0));
        label->setText(QApplication::translate("QPageSetupWidget", "Page order:", 0));
        label_2->setText(QApplication::translate("QPageSetupWidget", "Pages per sheet:", 0));
    } // retranslateUi
