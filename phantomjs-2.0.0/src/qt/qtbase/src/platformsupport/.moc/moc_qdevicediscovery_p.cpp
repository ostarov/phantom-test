...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QDeviceDiscovery_t, stringdata) + ofs \
...
QT_MOC_LITERAL(15, 213, 16)
    ...
    "Device_Tablet\0Device_InputMask\0"
    "Device_VideoMask"
};
...
static const uint qt_meta_data_QDeviceDiscovery[] = {
 ...
 // enum data: key, value
      ...
      14, uint(QDeviceDiscovery::Device_InputMask),
      15, uint(QDeviceDiscovery::Device_VideoMask),
...
const QMetaObject QDeviceDiscovery::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QDeviceDiscovery.data,
      qt_meta_data_QDeviceDiscovery,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QDeviceDiscovery.stringdata))
