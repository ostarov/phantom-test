...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QInotifyFileSystemWatcherEngine_t, stringdata) + ofs \
...
const QMetaObject QInotifyFileSystemWatcherEngine::staticMetaObject = {
    { &QFileSystemWatcherEngine::staticMetaObject, qt_meta_stringdata_QInotifyFileSystemWatcherEngine.data,
      qt_meta_data_QInotifyFileSystemWatcherEngine,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QInotifyFileSystemWatcherEngine.stringdata))
