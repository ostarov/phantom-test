...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QTemporaryFile_t, stringdata) + ofs \
...
const QMetaObject QTemporaryFile::staticMetaObject = {
    { &QFile::staticMetaObject, qt_meta_stringdata_QTemporaryFile.data,
      qt_meta_data_QTemporaryFile,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QTemporaryFile.stringdata))
