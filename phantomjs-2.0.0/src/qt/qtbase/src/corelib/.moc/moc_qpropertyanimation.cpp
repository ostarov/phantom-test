...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QPropertyAnimation_t, stringdata) + ofs \
...
const QMetaObject QPropertyAnimation::staticMetaObject = {
    { &QVariantAnimation::staticMetaObject, qt_meta_stringdata_QPropertyAnimation.data,
      qt_meta_data_QPropertyAnimation,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QPropertyAnimation.stringdata))
