...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QDefaultAnimationDriver_t, stringdata) + ofs \
...
const QMetaObject QDefaultAnimationDriver::staticMetaObject = {
    { &QAnimationDriver::staticMetaObject, qt_meta_stringdata_QDefaultAnimationDriver.data,
      qt_meta_data_QDefaultAnimationDriver,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QDefaultAnimationDriver.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QAbstractAnimationTimer_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QAbstractAnimationTimer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QAbstractAnimationTimer.data,
      qt_meta_data_QAbstractAnimationTimer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QAbstractAnimationTimer.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QUnifiedTimer_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QUnifiedTimer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QUnifiedTimer.data,
      qt_meta_data_QUnifiedTimer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QUnifiedTimer.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QAnimationTimer_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QAnimationTimer::staticMetaObject = {
    { &QAbstractAnimationTimer::staticMetaObject, qt_meta_stringdata_QAnimationTimer.data,
      qt_meta_data_QAnimationTimer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QAnimationTimer.stringdata))
