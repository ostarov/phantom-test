...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QEventDispatcherUNIX_t, stringdata) + ofs \
...
const QMetaObject QEventDispatcherUNIX::staticMetaObject = {
    { &QAbstractEventDispatcher::staticMetaObject, qt_meta_stringdata_QEventDispatcherUNIX.data,
      qt_meta_data_QEventDispatcherUNIX,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QEventDispatcherUNIX.stringdata))
