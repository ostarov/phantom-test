...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QHistoryState_t, stringdata) + ofs \
...
static const uint qt_meta_data_QHistoryState[] = {
 ...
 // enum data: key, value
       5, uint(QHistoryState::ShallowHistory),
       6, uint(QHistoryState::DeepHistory),
...
const QMetaObject QHistoryState::staticMetaObject = {
    { &QAbstractState::staticMetaObject, qt_meta_stringdata_QHistoryState.data,
      qt_meta_data_QHistoryState,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QHistoryState.stringdata))
