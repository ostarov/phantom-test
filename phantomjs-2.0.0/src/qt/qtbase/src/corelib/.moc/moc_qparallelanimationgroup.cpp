...
const QMetaObject QParallelAnimationGroup::staticMetaObject = {
    { &QAnimationGroup::staticMetaObject, qt_meta_stringdata_QParallelAnimationGroup.data,
      qt_meta_data_QParallelAnimationGroup,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QParallelAnimationGroup.stringdata))
