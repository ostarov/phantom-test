...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QNonContiguousByteDevice_t, stringdata) + ofs \
...
const QMetaObject QNonContiguousByteDevice::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QNonContiguousByteDevice.data,
      qt_meta_data_QNonContiguousByteDevice,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QNonContiguousByteDevice.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QNonContiguousByteDeviceIoDeviceImpl_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QNonContiguousByteDeviceIoDeviceImpl::staticMetaObject = {
    { &QNonContiguousByteDevice::staticMetaObject, qt_meta_stringdata_QNonContiguousByteDeviceIoDeviceImpl.data,
      qt_meta_data_QNonContiguousByteDeviceIoDeviceImpl,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QNonContiguousByteDeviceIoDeviceImpl.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QNonContiguousByteDeviceBufferImpl_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QNonContiguousByteDeviceBufferImpl::staticMetaObject = {
    { &QNonContiguousByteDevice::staticMetaObject, qt_meta_stringdata_QNonContiguousByteDeviceBufferImpl.data,
      qt_meta_data_QNonContiguousByteDeviceBufferImpl,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QNonContiguousByteDeviceBufferImpl.stringdata))
