...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QVariantAnimation_t, stringdata) + ofs \
...
const QMetaObject QVariantAnimation::staticMetaObject = {
    { &QAbstractAnimation::staticMetaObject, qt_meta_stringdata_QVariantAnimation.data,
      qt_meta_data_QVariantAnimation,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QVariantAnimation.stringdata))
