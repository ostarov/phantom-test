...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QObject_t, stringdata) + ofs \
...
const QMetaObject QObject::staticMetaObject = {
    { 0, qt_meta_stringdata_QObject.data,
      qt_meta_data_QObject,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QObject.stringdata))
