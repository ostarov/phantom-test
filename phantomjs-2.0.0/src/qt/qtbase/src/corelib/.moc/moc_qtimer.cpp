...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QTimer_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 43, 8),
QT_MOC_LITERAL(8, 52, 13),
QT_MOC_LITERAL(9, 66, 9),
QT_MOC_LITERAL(10, 76, 13),
...
const QMetaObject QTimer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QTimer.data,
      qt_meta_data_QTimer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QTimer.stringdata))
...
int QTimer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: *reinterpret_cast< int*>(_v) = remainingTime(); break;
        case 3: *reinterpret_cast< Qt::TimerType*>(_v) = timerType(); break;
        case 4: *reinterpret_cast< bool*>(_v) = isActive(); break;
        }
        _id -= 5;
        ...
        case 3: setTimerType(*reinterpret_cast< Qt::TimerType*>(_v)); break;
        }
        _id -= 5;
