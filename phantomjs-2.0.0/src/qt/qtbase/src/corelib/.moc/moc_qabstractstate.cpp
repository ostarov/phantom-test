...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QAbstractState_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 24, 6)
    ...
    "QAbstractState\0entered\0\0exited"
};
...
const QMetaObject QAbstractState::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QAbstractState.data,
      qt_meta_data_QAbstractState,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QAbstractState.stringdata))
