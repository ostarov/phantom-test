...
const QMetaObject QSequentialAnimationGroup::staticMetaObject = {
    { &QAnimationGroup::staticMetaObject, qt_meta_stringdata_QSequentialAnimationGroup.data,
      qt_meta_data_QSequentialAnimationGroup,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QSequentialAnimationGroup.stringdata))
