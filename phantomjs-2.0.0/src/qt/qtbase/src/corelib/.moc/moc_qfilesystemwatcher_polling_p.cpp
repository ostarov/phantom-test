...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QPollingFileSystemWatcherEngine_t, stringdata) + ofs \
...
const QMetaObject QPollingFileSystemWatcherEngine::staticMetaObject = {
    { &QFileSystemWatcherEngine::staticMetaObject, qt_meta_stringdata_QPollingFileSystemWatcherEngine.data,
      qt_meta_data_QPollingFileSystemWatcherEngine,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QPollingFileSystemWatcherEngine.stringdata))
