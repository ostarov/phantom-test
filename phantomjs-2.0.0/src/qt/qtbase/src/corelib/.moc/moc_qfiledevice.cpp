...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QFileDevice_t, stringdata) + ofs \
...
const QMetaObject QFileDevice::staticMetaObject = {
    { &QIODevice::staticMetaObject, qt_meta_stringdata_QFileDevice.data,
      qt_meta_data_QFileDevice,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QFileDevice.stringdata))
