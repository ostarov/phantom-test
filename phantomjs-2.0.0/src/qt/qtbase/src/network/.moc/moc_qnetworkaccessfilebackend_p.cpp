...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QNetworkAccessFileBackend_t, stringdata) + ofs \
...
const QMetaObject QNetworkAccessFileBackend::staticMetaObject = {
    { &QNetworkAccessBackend::staticMetaObject, qt_meta_stringdata_QNetworkAccessFileBackend.data,
      qt_meta_data_QNetworkAccessFileBackend,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QNetworkAccessFileBackend.stringdata))
