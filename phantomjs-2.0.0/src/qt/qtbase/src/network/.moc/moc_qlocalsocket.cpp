...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QLocalSocket_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 43, 30),
QT_MOC_LITERAL(6, 74, 11),
QT_MOC_LITERAL(7, 86, 12),
QT_MOC_LITERAL(8, 99, 30),
QT_MOC_LITERAL(9, 130, 11),
QT_MOC_LITERAL(10, 142, 15),
QT_MOC_LITERAL(11, 158, 28),
QT_MOC_LITERAL(12, 187, 8),
QT_MOC_LITERAL(13, 196, 28),
QT_MOC_LITERAL(14, 225, 18),
QT_MOC_LITERAL(15, 244, 25)
    },
...
const QMetaObject QLocalSocket::staticMetaObject = {
    { &QIODevice::staticMetaObject, qt_meta_stringdata_QLocalSocket.data,
      qt_meta_data_QLocalSocket,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QLocalSocket.stringdata))
