...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QHttpSocketEngine_t, stringdata) + ofs \
...
QT_MOC_LITERAL(8, 157, 5),
QT_MOC_LITERAL(9, 163, 22),
QT_MOC_LITERAL(10, 186, 28),
QT_MOC_LITERAL(11, 215, 5),
QT_MOC_LITERAL(12, 221, 27),
QT_MOC_LITERAL(13, 249, 28),
QT_MOC_LITERAL(14, 278, 33)
    },
...
const QMetaObject QHttpSocketEngine::staticMetaObject = {
    { &QAbstractSocketEngine::staticMetaObject, qt_meta_stringdata_QHttpSocketEngine.data,
      qt_meta_data_QHttpSocketEngine,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QHttpSocketEngine.stringdata))
