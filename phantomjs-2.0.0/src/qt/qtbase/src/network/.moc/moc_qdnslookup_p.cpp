...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QDnsLookupRunnable_t, stringdata) + ofs \
...
const QMetaObject QDnsLookupRunnable::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QDnsLookupRunnable.data,
      qt_meta_data_QDnsLookupRunnable,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QDnsLookupRunnable.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QDnsLookupThreadPool_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QDnsLookupThreadPool::staticMetaObject = {
    { &QThreadPool::staticMetaObject, qt_meta_stringdata_QDnsLookupThreadPool.data,
      qt_meta_data_QDnsLookupThreadPool,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QDnsLookupThreadPool.stringdata))
