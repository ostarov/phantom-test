...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QNetworkAccessFtpBackend_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 45, 37),
QT_MOC_LITERAL(4, 83, 6),
QT_MOC_LITERAL(5, 90, 7),
...
const QMetaObject QNetworkAccessFtpBackend::staticMetaObject = {
    { &QNetworkAccessBackend::staticMetaObject, qt_meta_stringdata_QNetworkAccessFtpBackend.data,
      qt_meta_data_QNetworkAccessFtpBackend,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QNetworkAccessFtpBackend.stringdata))
