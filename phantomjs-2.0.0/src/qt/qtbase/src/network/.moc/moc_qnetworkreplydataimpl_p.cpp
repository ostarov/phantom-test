...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QNetworkReplyDataImpl_t, stringdata) + ofs \
...
const QMetaObject QNetworkReplyDataImpl::staticMetaObject = {
    { &QNetworkReply::staticMetaObject, qt_meta_stringdata_QNetworkReplyDataImpl.data,
      qt_meta_data_QNetworkReplyDataImpl,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QNetworkReplyDataImpl.stringdata))
