...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QNativeSocketEngine_t, stringdata) + ofs \
...
const QMetaObject QNativeSocketEngine::staticMetaObject = {
    { &QAbstractSocketEngine::staticMetaObject, qt_meta_stringdata_QNativeSocketEngine.data,
      qt_meta_data_QNativeSocketEngine,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QNativeSocketEngine.stringdata))
