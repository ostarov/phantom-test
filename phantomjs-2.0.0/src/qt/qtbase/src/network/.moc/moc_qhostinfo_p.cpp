...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QHostInfoResult_t, stringdata) + ofs \
...
const QMetaObject QHostInfoResult::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QHostInfoResult.data,
      qt_meta_data_QHostInfoResult,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QHostInfoResult.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QHostInfoAgent_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QHostInfoAgent::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QHostInfoAgent.data,
      qt_meta_data_QHostInfoAgent,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QHostInfoAgent.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QAbstractHostInfoLookupManager_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QAbstractHostInfoLookupManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QAbstractHostInfoLookupManager.data,
      qt_meta_data_QAbstractHostInfoLookupManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QAbstractHostInfoLookupManager.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QHostInfoLookupManager_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QHostInfoLookupManager::staticMetaObject = {
    { &QAbstractHostInfoLookupManager::staticMetaObject, qt_meta_stringdata_QHostInfoLookupManager.data,
      qt_meta_data_QHostInfoLookupManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QHostInfoLookupManager.stringdata))
