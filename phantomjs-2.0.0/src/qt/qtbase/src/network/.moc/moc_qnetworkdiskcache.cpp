...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QNetworkDiskCache_t, stringdata) + ofs \
...
const QMetaObject QNetworkDiskCache::staticMetaObject = {
    { &QAbstractNetworkCache::staticMetaObject, qt_meta_stringdata_QNetworkDiskCache.data,
      qt_meta_data_QNetworkDiskCache,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QNetworkDiskCache.stringdata))
