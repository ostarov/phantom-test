...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QAbstractSocketEngine_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 121, 27),
QT_MOC_LITERAL(8, 149, 13),
QT_MOC_LITERAL(9, 163, 5),
QT_MOC_LITERAL(10, 169, 15),
QT_MOC_LITERAL(11, 185, 13)
    },
...
const QMetaObject QAbstractSocketEngine::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QAbstractSocketEngine.data,
      qt_meta_data_QAbstractSocketEngine,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QAbstractSocketEngine.stringdata))
