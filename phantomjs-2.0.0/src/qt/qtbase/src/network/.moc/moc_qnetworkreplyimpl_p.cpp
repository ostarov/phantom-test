...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QNetworkReplyImpl_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 54, 26),
QT_MOC_LITERAL(5, 81, 21),
QT_MOC_LITERAL(6, 103, 29),
QT_MOC_LITERAL(7, 133, 26),
QT_MOC_LITERAL(8, 160, 23),
QT_MOC_LITERAL(9, 184, 37),
QT_MOC_LITERAL(10, 222, 30)
    },
...
void QNetworkReplyImpl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 7: _t->d_func()->_q_networkSessionUsagePoliciesChanged((*reinterpret_cast< QNetworkSession::UsagePolicies(*)>(_a[1]))); break;
        default: ;
        }
...
const QMetaObject QNetworkReplyImpl::staticMetaObject = {
    { &QNetworkReply::staticMetaObject, qt_meta_stringdata_QNetworkReplyImpl.data,
      qt_meta_data_QNetworkReplyImpl,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QNetworkReplyImpl.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QDisabledNetworkReply_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QDisabledNetworkReply::staticMetaObject = {
    { &QNetworkReply::staticMetaObject, qt_meta_stringdata_QDisabledNetworkReply.data,
      qt_meta_data_QDisabledNetworkReply,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QDisabledNetworkReply.stringdata))
