...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QBearerEngineImpl_t, stringdata) + ofs \
...
const QMetaObject QBearerEngineImpl::staticMetaObject = {
    { &QBearerEngine::staticMetaObject, qt_meta_stringdata_QBearerEngineImpl.data,
      qt_meta_data_QBearerEngineImpl,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QBearerEngineImpl.stringdata))
