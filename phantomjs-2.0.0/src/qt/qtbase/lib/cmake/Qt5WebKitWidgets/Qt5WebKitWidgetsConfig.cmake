...
set(Qt5WebKitWidgets_VERSION_STRING 5.3.1)
...
if (NOT TARGET Qt5::WebKitWidgets)
    ...
    set(Qt5WebKitWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5WebKitWidgets_install_prefix}/include/QtWebKitWidgets/5.3.1"
        "${_qt5WebKitWidgets_install_prefix}/include/QtWebKitWidgets/5.3.1/QtWebKitWidgets"
    )
    ...
    set(_Qt5WebKitWidgets_MODULE_DEPENDENCIES "PrintSupport;WebKit;Widgets;Network;Gui;Core")
    ...
    foreach(_module_dep ${_Qt5WebKitWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.3.1 ${_Qt5WebKitWidgets_FIND_VERSION_EXACT}
    ...
    set(_Qt5WebKitWidgets_LIB_DEPENDENCIES "Qt5::PrintSupport;Qt5::WebKit;Qt5::Widgets;Qt5::Network;Qt5::Gui;Qt5::Core")

    add_library(Qt5::WebKitWidgets STATIC IMPORTED)
    set_property(TARGET Qt5::WebKitWidgets PROPERTY IMPORTED_LINK_INTERFACE_LANGUAGES CXX)
    ...
    _populate_WebKitWidgets_target_properties(RELEASE "libQt5WebKitWidgets.a" "" )
