...
set(Qt5WebKit_VERSION_STRING 5.3.1)
...
if (NOT TARGET Qt5::WebKit)
    ...
    set(Qt5WebKit_PRIVATE_INCLUDE_DIRS
        "${_qt5WebKit_install_prefix}/include/QtWebKit/5.3.1"
        "${_qt5WebKit_install_prefix}/include/QtWebKit/5.3.1/QtWebKit"
    )
    ...
    foreach(_module_dep ${_Qt5WebKit_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.3.1 ${_Qt5WebKit_FIND_VERSION_EXACT}
    ...
    add_library(Qt5::WebKit STATIC IMPORTED)
    set_property(TARGET Qt5::WebKit PROPERTY IMPORTED_LINK_INTERFACE_LANGUAGES CXX)
    ...
    _populate_WebKit_target_properties(RELEASE "libQt5WebKit.a" "" )
