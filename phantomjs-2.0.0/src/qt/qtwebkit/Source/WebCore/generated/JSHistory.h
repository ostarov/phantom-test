...
public:
    ...
    static JSHistoryConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSHistoryConstructor* ptr = new (NotNull, JSC::allocateCell<JSHistoryConstructor>(*exec->heap())) JSHistoryConstructor(structure, globalObject);
...
JSC::JSValue jsHistoryConstructor(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
