...
public:
    ...
    static JSPerformanceConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSPerformanceConstructor* ptr = new (NotNull, JSC::allocateCell<JSPerformanceConstructor>(*exec->heap())) JSPerformanceConstructor(structure, globalObject);
