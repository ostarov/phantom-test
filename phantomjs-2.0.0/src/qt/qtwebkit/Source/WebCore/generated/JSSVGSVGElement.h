...
public:
    ...
    static JSSVGSVGElementConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSSVGSVGElementConstructor* ptr = new (NotNull, JSC::allocateCell<JSSVGSVGElementConstructor>(*exec->heap())) JSSVGSVGElementConstructor(structure, globalObject);
