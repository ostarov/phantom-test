...
public:
    ...
    {
        JSEntityReferenceConstructor* ptr = new (NotNull, JSC::allocateCell<JSEntityReferenceConstructor>(*exec->heap())) JSEntityReferenceConstructor(structure, globalObject);
