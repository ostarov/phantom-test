...
public:
    ...
    static JSDOMImplementationConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSDOMImplementationConstructor* ptr = new (NotNull, JSC::allocateCell<JSDOMImplementationConstructor>(*exec->heap())) JSDOMImplementationConstructor(structure, globalObject);
...
JSC::JSValue jsDOMImplementationConstructor(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
