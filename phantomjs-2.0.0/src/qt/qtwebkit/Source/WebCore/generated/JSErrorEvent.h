...
public:
    ...
    static JSErrorEventConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSErrorEventConstructor* ptr = new (NotNull, JSC::allocateCell<JSErrorEventConstructor>(*exec->heap())) JSErrorEventConstructor(structure, globalObject);
