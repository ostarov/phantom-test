...
public:
    ...
    {
        JSSVGAnimateMotionElementConstructor* ptr = new (NotNull, JSC::allocateCell<JSSVGAnimateMotionElementConstructor>(*exec->heap())) JSSVGAnimateMotionElementConstructor(structure, globalObject);
