...
public:
    ...
    static JSSVGAnimatedStringConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSSVGAnimatedStringConstructor* ptr = new (NotNull, JSC::allocateCell<JSSVGAnimatedStringConstructor>(*exec->heap())) JSSVGAnimatedStringConstructor(structure, globalObject);
