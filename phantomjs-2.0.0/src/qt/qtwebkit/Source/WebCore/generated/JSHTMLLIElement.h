...
public:
    ...
    static JSHTMLLIElementConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSHTMLLIElementConstructor* ptr = new (NotNull, JSC::allocateCell<JSHTMLLIElementConstructor>(*exec->heap())) JSHTMLLIElementConstructor(structure, globalObject);
...
JSC::JSValue jsHTMLLIElementType(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
void setJSHTMLLIElementType(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsHTMLLIElementValue(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
void setJSHTMLLIElementValue(JSC::ExecState*, JSC::JSObject*, JSC::JSValue);
JSC::JSValue jsHTMLLIElementConstructor(JSC::ExecState*, JSC::JSValue, JSC::PropertyName);
