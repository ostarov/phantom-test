...
public:
    ...
    {
        JSSVGFEFuncAElementConstructor* ptr = new (NotNull, JSC::allocateCell<JSSVGFEFuncAElementConstructor>(*exec->heap())) JSSVGFEFuncAElementConstructor(structure, globalObject);
