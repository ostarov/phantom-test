...
class JSSVGFETurbulenceElement : public JSSVGStyledElement {
public:
...
public:
    ...
    static JSSVGFETurbulenceElementConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSSVGFETurbulenceElementConstructor* ptr = new (NotNull, JSC::allocateCell<JSSVGFETurbulenceElementConstructor>(*exec->heap())) JSSVGFETurbulenceElementConstructor(structure, globalObject);
