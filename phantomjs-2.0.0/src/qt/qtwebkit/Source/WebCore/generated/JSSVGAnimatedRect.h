...
public:
    ...
    static JSSVGAnimatedRectConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSSVGAnimatedRectConstructor* ptr = new (NotNull, JSC::allocateCell<JSSVGAnimatedRectConstructor>(*exec->heap())) JSSVGAnimatedRectConstructor(structure, globalObject);
