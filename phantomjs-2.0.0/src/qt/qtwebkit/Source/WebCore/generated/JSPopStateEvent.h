...
public:
    ...
    static JSPopStateEventConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSPopStateEventConstructor* ptr = new (NotNull, JSC::allocateCell<JSPopStateEventConstructor>(*exec->heap())) JSPopStateEventConstructor(structure, globalObject);
