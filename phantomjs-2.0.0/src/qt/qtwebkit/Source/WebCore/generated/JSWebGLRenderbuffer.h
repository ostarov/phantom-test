...
public:
    ...
    {
        JSWebGLRenderbufferConstructor* ptr = new (NotNull, JSC::allocateCell<JSWebGLRenderbufferConstructor>(*exec->heap())) JSWebGLRenderbufferConstructor(structure, globalObject);
