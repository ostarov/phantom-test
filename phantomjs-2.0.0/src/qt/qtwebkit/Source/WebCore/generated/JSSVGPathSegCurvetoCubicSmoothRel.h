...
public:
    ...
    static JSSVGPathSegCurvetoCubicSmoothRelConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSSVGPathSegCurvetoCubicSmoothRelConstructor* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegCurvetoCubicSmoothRelConstructor>(*exec->heap())) JSSVGPathSegCurvetoCubicSmoothRelConstructor(structure, globalObject);
