...
public:
    ...
    static JSSVGTSpanElementConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSSVGTSpanElementConstructor* ptr = new (NotNull, JSC::allocateCell<JSSVGTSpanElementConstructor>(*exec->heap())) JSSVGTSpanElementConstructor(structure, globalObject);
