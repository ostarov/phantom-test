...
public:
    ...
    static JSTouchEventConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSTouchEventConstructor* ptr = new (NotNull, JSC::allocateCell<JSTouchEventConstructor>(*exec->heap())) JSTouchEventConstructor(structure, globalObject);
