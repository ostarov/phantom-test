...
public:
    ...
    static JSProgressEventConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSProgressEventConstructor* ptr = new (NotNull, JSC::allocateCell<JSProgressEventConstructor>(*exec->heap())) JSProgressEventConstructor(structure, globalObject);
