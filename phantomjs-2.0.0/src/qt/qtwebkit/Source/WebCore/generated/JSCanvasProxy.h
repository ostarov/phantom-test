...
public:
    ...
    static JSCanvasProxyConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSCanvasProxyConstructor* ptr = new (NotNull, JSC::allocateCell<JSCanvasProxyConstructor>(*exec->heap())) JSCanvasProxyConstructor(structure, globalObject);
