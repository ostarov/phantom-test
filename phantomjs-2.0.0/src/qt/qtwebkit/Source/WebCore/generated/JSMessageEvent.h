...
public:
    ...
    static JSMessageEventConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSMessageEventConstructor* ptr = new (NotNull, JSC::allocateCell<JSMessageEventConstructor>(*exec->heap())) JSMessageEventConstructor(structure, globalObject);
