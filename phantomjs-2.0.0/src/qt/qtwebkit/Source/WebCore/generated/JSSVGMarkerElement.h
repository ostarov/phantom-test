...
class JSSVGMarkerElement : public JSSVGStyledElement {
public:
...
public:
    ...
    static JSSVGMarkerElementConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSSVGMarkerElementConstructor* ptr = new (NotNull, JSC::allocateCell<JSSVGMarkerElementConstructor>(*exec->heap())) JSSVGMarkerElementConstructor(structure, globalObject);
