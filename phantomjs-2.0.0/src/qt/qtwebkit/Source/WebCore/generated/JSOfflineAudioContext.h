...
public:
    ...
    static JSOfflineAudioContextConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSOfflineAudioContextConstructor* ptr = new (NotNull, JSC::allocateCell<JSOfflineAudioContextConstructor>(*exec->heap())) JSOfflineAudioContextConstructor(structure, globalObject);
