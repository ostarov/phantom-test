...
public:
    ...
    {
        JSDOMSettableTokenListConstructor* ptr = new (NotNull, JSC::allocateCell<JSDOMSettableTokenListConstructor>(*exec->heap())) JSDOMSettableTokenListConstructor(structure, globalObject);
