...
public:
    ...
    {
        JSHTMLContentElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLContentElement>(globalObject->vm().heap)) JSHTMLContentElement(structure, globalObject, impl);
...
public:
    ...
    static JSHTMLContentElementPrototype* create(JSC::VM& vm, JSC::JSGlobalObject* globalObject, JSC::Structure* structure)
    {
        JSHTMLContentElementPrototype* ptr = new (NotNull, JSC::allocateCell<JSHTMLContentElementPrototype>(vm.heap)) JSHTMLContentElementPrototype(vm, globalObject, structure);
...
private:
    JSHTMLContentElementPrototype(JSC::VM& vm, JSC::JSGlobalObject*, JSC::Structure* structure) : JSC::JSNonFinalObject(vm, structure) { }
protected:
