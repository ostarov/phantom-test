...
public:
    ...
    static JSIDBOpenDBRequestConstructor* create(JSC::ExecState* exec, JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        JSIDBOpenDBRequestConstructor* ptr = new (NotNull, JSC::allocateCell<JSIDBOpenDBRequestConstructor>(*exec->heap())) JSIDBOpenDBRequestConstructor(structure, globalObject);
