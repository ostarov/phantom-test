...
#include "../qt/WebCoreSupport/IconDatabaseClientQt.h"
...
struct qt_meta_stringdata_WebCore__IconDatabaseClientQt_t {
    QByteArrayData data[3];
    char stringdata[52];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_WebCore__IconDatabaseClientQt_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_WebCore__IconDatabaseClientQt_t qt_meta_stringdata_WebCore__IconDatabaseClientQt = {
    {
QT_MOC_LITERAL(0, 0, 29),
QT_MOC_LITERAL(1, 30, 20),
QT_MOC_LITERAL(2, 51, 0)
    },
    "WebCore::IconDatabaseClientQt\0"
    "iconLoadedForPageURL\0"
};
...
void WebCore::IconDatabaseClientQt::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (IconDatabaseClientQt::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&IconDatabaseClientQt::iconLoadedForPageURL)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject WebCore::IconDatabaseClientQt::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_WebCore__IconDatabaseClientQt.data,
      qt_meta_data_WebCore__IconDatabaseClientQt,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WebCore__IconDatabaseClientQt.stringdata))
