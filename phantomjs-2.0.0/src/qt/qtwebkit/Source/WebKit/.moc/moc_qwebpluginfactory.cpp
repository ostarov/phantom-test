...
#include "../qt/Api/qwebpluginfactory.h"
...
struct qt_meta_stringdata_QWebPluginFactory_t {
    QByteArrayData data[1];
    char stringdata[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QWebPluginFactory_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QWebPluginFactory_t qt_meta_stringdata_QWebPluginFactory = {
    {
...
const QMetaObject QWebPluginFactory::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QWebPluginFactory.data,
      qt_meta_data_QWebPluginFactory,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QWebPluginFactory.stringdata))
