...
#include "../qt/WebCoreSupport/NotificationPresenterClientQt.h"
...
struct qt_meta_stringdata_WebCore__NotificationWrapper_t {
    QByteArrayData data[4];
    char stringdata[69];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_WebCore__NotificationWrapper_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_WebCore__NotificationWrapper_t qt_meta_stringdata_WebCore__NotificationWrapper = {
    {
QT_MOC_LITERAL(0, 0, 28),
QT_MOC_LITERAL(1, 29, 18),
QT_MOC_LITERAL(2, 48, 0),
QT_MOC_LITERAL(3, 49, 19)
    },
    "WebCore::NotificationWrapper\0"
    "notificationClosed\0\0notificationClicked"
};
...
const QMetaObject WebCore::NotificationWrapper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_WebCore__NotificationWrapper.data,
      qt_meta_data_WebCore__NotificationWrapper,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WebCore__NotificationWrapper.stringdata))
